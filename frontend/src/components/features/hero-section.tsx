...
export function HeroSection() {
  return (
    <section className="relative overflow-hidden bg-brand py-14 sm:py-18 md:py-24 lg:py-28 pb-28 sm:pb-36 md:pb-44 lg:pb-52">
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-2 sm:gap-3 px-2">
            {tags.map((tag) => (
              <button
                key={tag}
                className="px-4 sm:px-5 py-1.5 sm:py-2 bg-white border-2 border-black rounded-full text-sm font-medium shadow-brutal-sm hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-none transition-all active:translate-x-[2px] active:translate-y-[2px] active:shadow-none"
              >
                {tag}
              </button>
            ))}
