...
export function HeroSection() {
  return (
    <section className="relative overflow-hidden bg-brand py-12 sm:py-16 md:py-20 lg:py-24 pb-28 sm:pb-32 md:pb-36 lg:pb-40">
      ...
      <div className="absolute -bottom-1 left-0 w-[180px] sm:w-[280px] md:w-[400px] lg:w-[550px] xl:w-[650px] pointer-events-none select-none origin-bottom-left animate-wobble-slow -scale-x-100">
        <Image
      ...
      <div className="absolute -bottom-1 right-0 w-[180px] sm:w-[280px] md:w-[400px] lg:w-[550px] xl:w-[650px] pointer-events-none select-none origin-bottom-right animate-wobble-slow-alt -scale-x-100">
        <Image
          src="/images/Vector 70.png"
          alt=""
          width={700}
