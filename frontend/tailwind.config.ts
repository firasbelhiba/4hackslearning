...
const config: Config = {
  ...
  theme: {
    ...
    extend: {
      colors: {
        // Brand Color - 4hacks Learning (#D6FF25)
        brand: {
          DEFAULT: 'hsl(var(--brand))',
          light: 'hsl(var(--brand-light))',
          dark: 'hsl(var(--brand-dark))',
        },
        // Supporting Colors (using CSS variables)
        pink: {
      ...
      keyframes: {
        ...
        'wobble-slow-reverse': {
          ...
          '25%': { transform: 'scaleX(-1) rotate(0.5deg) translateY(3px)' },
          '50%': { transform: 'scaleX(-1) rotate(1deg) translateY(0)' },
          '75%': { transform: 'scaleX(-1) rotate(-0.5deg) translateY(-3px)' },
        },
      },
      animation: {
        ...
        'wobble-slow-reverse': 'wobble-slow-reverse 7s ease-in-out infinite',
      },
      backgroundImage: {
